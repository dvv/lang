(function () { function require(p){ var path = require.resolve(p) , mod = require.modules[path]; if (!mod) throw new Error('failed to require "' + p + '"'); if (!mod.exports) { mod.exports = {}; mod.call(mod.exports, mod, mod.exports, require.relative(path)); } return mod.exports;}require.modules = {};require.resolve = function(path){ var orig = path , reg = path + '.js' , index = path + '/index.js'; return require.modules[reg] && reg || require.modules[index] && index || orig;};require.register = function(path, fn){ require.modules[path] = fn;};require.relative = function(parent) { return function(p){ if ('.' != p.charAt(0)) return require(p); var path = parent.split('/') , segs = p.split('/'); path.pop(); for (var i = 0; i < segs.length; i++) { var seg = segs[i]; if ('..' == seg) path.pop(); else if ('.' != seg) path.push(seg); } return require(path.join('/')); };};require.register("compose.js", function(module, exports, require){
/*
...
});require.register("plurals.js", function(module, exports, require){
'use strict';
...
L.add('fr', {bu1:'C\'est une texte simple. Plus, reused #{this.bar}'});
L.add('fr', {bu2:'C\'est une texte simple. Plus, reused #{this.baz}'});
...
console.log(L.bar({wives: 5, children: 101}));
console.log(L.bu1({wives: 1, children: 11}));
console.log(L.bu2({wives: 1, children: 11}));
